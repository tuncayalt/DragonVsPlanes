...
public class MainThread extends Thread{
	...
	// desired fps
	private int MAX_FPS = Parameter.MAX_FPS;
	// maximum number of frames to be skipped
	private int	MAX_FRAME_SKIPS = Parameter.MAX_FRAME_SKIPS;
	// the frame period
	...
	/*private void storeStats() {
		...
		if (statusIntervalTimer >= lastStatusStore + STAT_INTERVAL) {
			...
			//gamePanel.setAvgFps("life " + gamePanel.goodBubble.getBody().getLife());
		}
	}
