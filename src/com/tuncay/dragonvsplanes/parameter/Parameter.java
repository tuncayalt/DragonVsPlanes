...
public class Parameter {
	...
	public static int bubbleEmergePointNumber = 5;
	public static float flagCreationProbability = 60;
	public static int flagMaxEffectiveAge = 700;
	public static int flagMaxNonEffectiveAge = 350;
